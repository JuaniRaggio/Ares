...
#include "../fonts/font_ubuntu_mono.h"
...
uint32_t vgaToRGB(uint8_t color) {
    switch (color & 0x0F) {
        case 0x00: return 0x000000; // negro
        case 0x01: return 0x0000FF; // azul
        case 0x02: return 0x00FF00; // verde
        case 0x04: return 0xFF0000; // rojo
        case 0x07: return 0xC0C0C0; // gris
        case 0x0F: return 0xFFFFFF; // blanco
